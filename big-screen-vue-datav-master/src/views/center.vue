<template>
  <div id="center">
    <div class="up">
      ...
      >
        <p class="ml-3 colorBlue fw-b ">车辆总数据</p>
      ...
      >
        <p class="ml-3 colorBlue fw-b ">销售最多汽车</p>
        <div style="text-align: center;line-height: 2">
          {{this.result.topCar}}
        </div>
      </div>
<div
      ...
      >
        <p class="ml-3 colorBlue fw-b ">车辆最高销售额</p>
        <div style="text-align: center;line-height: 2">
      ...
      >
        <p class="ml-3 colorBlue fw-b ">销售最多车型</p>
        <div style="text-align: center;line-height: 2">
          {{this.result.mostModdel}}
        </div>
      </div>
      <div
        class="bg-color-black item"
      ...
      >
        <p class="ml-3 colorBlue fw-b ">车型最多品牌</p>
        <div style="text-align: center;line-height: 2">
      ...
      >
        <p class="ml-3 colorBlue fw-b ">车辆平局价格</p>
        <div style="text-align: center;line-height: 2">
          {{this.result.averagePrices}}万
        </div>
      </div>
    ...
    <div class="down">
      <div class="ranking bg-color-black">
        ...
        <span class=" text mx-2 mb-1 pl-3">汽车品牌榜</span>
